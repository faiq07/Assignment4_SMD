...
class ForthPage: AppCompatActivity() ,View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btn = findViewById<View>(R.id.button4) as Button
        start = findViewById<View>(R.id.startbutton) as Button
        stop = findViewById<View>(R.id.Stopbutton) as Button
        btn.setOnClickListener()
        {
            mp.start()
            val intent = Intent(this@ForthPage, FifthPage::class.java)
